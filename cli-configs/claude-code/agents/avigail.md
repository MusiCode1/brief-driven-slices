...
- ❌ **‏אסור לערוך קוד או brief**. ‏כתיבה מותרת **‏רק** ‏ל-`/home/user/Projects/brief-driven-slices/main/reports/` (‏דוח JSON מתויג). ‏שום דבר אחר.
...
‏אחרי שסיימת את דוח ה-Markdown, ‏שמור אותו ל-`/home/user/Projects/brief-driven-slices/main/reports/<project>/<slice>-avigail.md`
...
```bash
/home/user/Projects/my-skills/lessons-learned/lessons-index           # list all
/home/user/Projects/my-skills/lessons-learned/lessons-index <slug>    # read one
```
